  ...
  return (
    ...
    >
      <path
        fillRule="evenodd"
        clipRule="evenodd"
        d="M2.25 12.75a.75.75 0 01.75-.75h18a.75.75 0 010 1.5H3a.75.75 0 01-.75-.75z"
        fill="currentColor"
      />
      <path
        fillRule="evenodd"
        clipRule="evenodd"
        d="M3.75 15.75a.75.75 0 01.75-.75h15a.75.75 0 010 1.5h-15a.75.75 0 01-.75-.75z"
        fill="currentColor"
      />
      <path
        fillRule="evenodd"
        clipRule="evenodd"
        d="M2.25 9.75a.75.75 0 01.75-.75h18a.75.75 0 010 1.5H3a.75.75 0 01-.75-.75z"
        fill="currentColor"
      />
      <path
        fillRule="evenodd"
        clipRule="evenodd"
        d="M3.75 6.75a.75.75 0 01.75-.75h15a.75.75 0 010 1.5h-15a.75.75 0 01-.75-.75z"
        fill="currentColor"
      />
    </svg>
  );
...
export function Dollar(props: PropsType) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={24}
    ...
    >
      <path
        fillRule="evenodd"
        clipRule="evenodd"
        d="M12 1.25a.75.75 0 01.75.75v.5a.75.75 0 01-1.5 0V2a.75.75 0 01.75-.75zM12 21.25a.75.75 0 01.75.75v.5a.75.75 0 01-1.5 0v-.5a.75.75 0 01.75-.75zM1.25 12a.75.75 0 01.75-.75h.5a.75.75 0 010 1.5H2a.75.75 0 01-.75-.75zM21.25 12a.75.75 0 01.75-.75h.5a.75.75 0 010 1.5h-.5a.75.75 0 01-.75-.75zM4.25 6.25a.75.75 0 01.75-.75h.5a.75.75 0 010 1.5H5a.75.75 0 01-.75-.75zM19.75 6.25a.75.75 0 01.75-.75h.5a.75.75 0 010 1.5h-.5a.75.75 0 01-.75-.75zM4.25 17.75a.75.75 0 01.75-.75h.5a.75.75 0 010 1.5H5a.75.75 0 01-.75-.75zM19.75 17.75a.75.75 0 01.75-.75h.5a.75.75 0 010 1.5h-.5a.75.75 0 01-.75-.75zM8.25 3.25a.75.75 0 01.75-.75h.5a.75.75 0 010 1.5H9a.75.75 0 01-.75-.75zM15.75 3.25a.75.75 0 01.75-.75h.5a.75.75 0 010 1.5h-.5a.75.75 0 01-.75-.75zM8.25 20.75a.75.75 0 01.75-.75h.5a.75.75 0 010 1.5H9a.75.75 0 01-.75-.75zM15.75 20.75a.75.75 0 01.75-.75h.5a.75.75 0 010 1.5h-.5a.75.75 0 01-.75-.75z"
        fill="currentColor"
      />
      <path
        d="M12 4.25c-4.28 0-7.75 3.47-7.75 7.75s3.47 7.75 7.75 7.75 7.75-3.47 7.75-7.75-3.47-7.75-7.75-7.75zM5.75 12c0-3.45 2.8-6.25 6.25-6.25s6.25 2.8 6.25 6.25-2.8 6.25-6.25 6.25S5.75 15.45 5.75 12z"
        fill="currentColor"
      />
    </svg>
  );
...
export function Wrench(props: PropsType) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={24}
  ...
  return (
    ...
    >
      <path
        fillRule="evenodd"
        clipRule="evenodd"
        d="M11.078 2.25c-.917 0-1.699.663-1.85 1.567L9.05 4.889c-.021.115-.062.226-.122.327l-.8 1.515a.75.75 0 01-1.072.248L5.232 5.516a.75.75 0 00-.9-.9L2.97 5.232a.75.75 0 01-.248-1.072l.8-1.515a1.75 1.75 0 00.122-.327L3.772 3.817c.151-.904.933-1.567 1.85-1.567h6.456zM12.922 2.25c.917 0 1.699.663 1.85 1.567l.178 1.072c.021.115.062.226.122.327l.8 1.515a.75.75 0 001.072.248l1.034-.632a.75.75 0 01.9.9l.632 1.034a.75.75 0 01-.248 1.072l-.8 1.515a1.75 1.75 0 00-.122.327l-.178 1.072c-.151.904-.933 1.567-1.85 1.567H5.622c-.917 0-1.699-.663-1.85-1.567L3.594 9.75a1.75 1.75 0 00-.122-.327l-.8-1.515a.75.75 0 01.248-1.072l.632-1.034a.75.75 0 01.9-.9l1.034.632a.75.75 0 001.072-.248l.8-1.515c.06-.101.1-.212.122-.327L5.622 3.817c.151-.904.933-1.567 1.85-1.567h5.45z"
        fill="currentColor"
      />
      <path
...
// Additional icons for Super Admin navigation
  ...
  return (
    ...
    >
      <path
        fillRule="evenodd"
        clipRule="evenodd"
        d="M3 3a.75.75 0 000 1.5v13.5a.75.75 0 001.5 0V4.5A.75.75 0 003 3zm4.5 4.5a.75.75 0 000 1.5v9a.75.75 0 001.5 0v-9a.75.75 0 00-1.5 0zm4.5 3a.75.75 0 000 1.5v6a.75.75 0 001.5 0v-6a.75.75 0 00-1.5 0zm4.5 1.5a.75.75 0 000 1.5v4.5a.75.75 0 001.5 0v-4.5a.75.75 0 00-1.5 0z"
        fill="currentColor"
      />
    </svg>
  );
...
export function ExclamationTriangleIcon(props: PropsType) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={24}
...
export function CurrencyDollarIcon(props: PropsType) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={24}
  ...
  return (
    ...
    >
      <path
        fillRule="evenodd"
        clipRule="evenodd"
        d="M1.5 8.67v8.58a3 3 0 003 3h15a3 3 0 003-3V8.67l-8.928 5.493a3 3 0 01-3.144 0L1.5 8.67zM12.75 6.908c2.708 0 5.25 1.343 6.75 3.409V6.75a3 3 0 00-3-3h-15a3 3 0 00-3 3v3.567c1.5-2.066 4.042-3.409 6.75-3.409z"
        fill="currentColor"
      />
    </svg>
  );
...
export function FlagIcon(props: PropsType) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={24}
    ...
    >
      <path
        fillRule="evenodd"
        clipRule="evenodd"
        d="M3 2.25a.75.75 0 01.75.75v.54l1.838-.46a9.75 9.75 0 016.725.738l.108.054a8.25 8.25 0 005.58.652l2.109-.732a.75.75 0 01.917.917l-.75 2.109a.75.75 0 01-.652.917l-2.109.732a8.25 8.25 0 01-5.58-.652l-.108-.054a9.75 9.75 0 00-6.725-.738L3.75 6.46v14.04a.75.75 0 01-1.5 0V3A.75.75 0 013 2.25z"
        fill="currentColor"
      />
    </svg>
  );
...
export function ArrowDownTrayIcon(props: PropsType) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={24}
  ...
  return (
    ...
    >
      <path
        fillRule="evenodd"
        clipRule="evenodd"
        d="M12.516 2.17a.75.75 0 00-1.032 0 11.209 11.209 0 01-7.877 3.08.75.75 0 00-.722.515A12.74 12.74 0 002.25 9.75c0 5.814 3.438 10.112 8.25 11.25 4.812-1.138 8.25-5.436 8.25-11.25 0-1.28-.15-2.52-.435-3.68a.75.75 0 00-.722-.515 11.209 11.209 0 01-7.877-3.08zM15.75 9.75a3.75 3.75 0 11-7.5 0 3.75 3.75 0 017.5 0zm-1.5 0a2.25 2.25 0 11-4.5 0 2.25 2.25 0 014.5 0z"
        fill="currentColor"
      />
    </svg>
  );
...
export function CheckBadgeIcon(props: PropsType) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={24}
